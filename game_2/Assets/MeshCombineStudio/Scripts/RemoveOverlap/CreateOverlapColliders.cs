...
namespace MeshCombineStudio
{
    ...
    public class CreateOverlapColliders : MonoBehaviour
    {
        ...
        static public void Create(Transform parentT, LayerMask overlapLayerMask, int lodGroupLayer, ref GameObject overlapCollidersGO, bool removeSamePositionTriangles)
        {
